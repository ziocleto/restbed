...
//Project Namespaces
using corvusoft::restbed::detail::WebSocketMessageImpl;
...
namespace corvusoft
{
    namespace restbed
    {
        ...
        //WebSocketMessage::WebSocketMessage( const WebSocketMessage::OperationCode code, const Bytes& data ) : WebSocketMessage( code, data, 0 )
        //{
        //    return;
        //}
        
        //WebSocketMessage::WebSocketMessage( const WebSocketMessage::OperationCode code, const string& data ) : WebSocketMessage( code, data, 0 )
        //{
        //    return;
        //}
        
        //WebSocketMessage::WebSocketMessage( const WebSocketMessage::OperationCode code, const Bytes& data, const uint32_t mask ) : m_pimpl( new WebSocketMessageImpl )
        //{
        // m_pimpl->m_data = data;
        // m_pimpl->m_mask = mask;
        ...
        //WebSocketMessage::WebSocketMessage( const WebSocketMessage::OperationCode code, const string& data, const uint32_t mask ) : WebSocketMessage( code, data, mask )
        //{
        //    return;
        //}
        ...
        WebSocketMessage::OperationCode WebSocketMessage::get_opcode( void ) const
        {
        ...
        void WebSocketMessage::set_opcode( const WebSocketMessage::OperationCode value )
        {
